...
if platform.system() == u'Windows':
    ...
    path = package_folder + '/lib/libarcsoft_fsdk_face_recognition.so'
    internalLibrary = CDLL(u'{}'.format(path))
    # internalLibrary = CDLL(u'/home/chengyuen93/Projects/ArcSoft_FaceRecognition/ArcSoft_FreeSDK_Demo/FR/python/libarcsoft_fsdk_face_recognition.so')
